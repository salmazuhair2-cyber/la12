    ...
    <div class="modal-overlay">
      ...
      <div class="form-box register">
        ...
        <form action="#">
          ...
          <div class="remember animation" style="--i:21; --j:4;">
            <label for=""> <input type="checkbox">Agree To The Terms & Account</label>

          </div>
          <button type="submit" class="login-btn animation" style="--i:22; --j:5;">Register</button>
